    ...
    questions: [
      {
        ...
        source: {
          range: "Slide 12 & 20 · Transcript T04-047–048",
          slide: 20,
          topic: "LLM Hallucination",
          note: "Review the real VLearn source on predict → append → rerun and why fluent text can still be wrong.",
      ...
      },
      {
        ...
        source: {
          range: "Slide 16 · Transcript T06-139",
          slide: 16,
          topic: "Grounding AI responses",
          note: "Review the VLearn section on retrieving the right context instead of relying on model memory.",
      ...
      },
      {
        ...
        source: {
          range: "Slide 16 · Transcripts T03-036, T06-139",
          slide: 16,
          topic: "RAG workflow",
          note: "Review the VLearn explanation of retrieval and adding relevant context before generation.",
      ...
      },
      {
        ...
        source: {
          range: "Slide 20 · Transcript T06-147–149",
          slide: 20,
          topic: "When to verify",
          note: "Review VLearn's knowledge-cutoff, hallucination, and context-window limits.",
      ...
      },
      {
        ...
        source: {
          range: "Slide 20 · Transcript T04-091",
          slide: 20,
          topic: "Verification workflow",
          note: "Review the VLearn summary on model limits, external tools, and evaluation.",
